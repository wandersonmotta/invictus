     ...
     <div className="space-y-6">
         ...
         <CardContent className="flex items-center gap-4">
           ...
           <div>
             ...
             <div className="mt-1 text-sm">
               ...
               <span className="font-mono">{withdrawal.pix_key}</span>
             </div>
           </div>
         </CardContent>
       </Card>
       ...
       <Card>
         ...
         <CardContent className="grid gap-4 sm:grid-cols-3">
           ...
           <div>
             <div className="text-sm text-muted-foreground">Taxa (4,99%)</div>
           ...
           <div className="sm:col-span-3">
             <div className="text-sm text-muted-foreground">Solicitado em</div>
             <div>
       ...
       <Card className={balanceMatches ? "border-green-500/50" : "border-destructive"}>
         ...
         <CardContent className="grid gap-4 sm:grid-cols-4">
           ...
           <div>
             ...
             <div className="text-lg font-semibold">{formatCurrency(expectedBalance)}</div>
           </div>
           <div>
             ...
             <div className="text-lg font-semibold">
               ...
               {balanceMatches && (
                 <span className="ml-2 text-sm text-green-500">[OK]</span>
               )}
             </div>
           </div>
           {financial_summary.pending_withdrawals > 0 && (
             <div className="sm:col-span-4">
               <div className="text-sm text-muted-foreground">Pendente de Aprovação</div>
