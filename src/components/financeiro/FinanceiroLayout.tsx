...
import { LogOut, FileText, ListChecks, BarChart3, Wallet, CreditCard, Monitor, Sun, Moon, Users } from "lucide-react";
      ...
      <aside className="hidden w-64 flex-col border-r border-border bg-card lg:flex">
        ...
        <div className="border-t border-border p-4 space-y-4">
          ...
          <div className="px-1">
            ...
            >
              <ToggleGroupItem value="system" aria-label="Padrão do sistema" className="flex-1 gap-1 px-2 py-1.5 text-xs data-[state=on]:bg-accent data-[state=on]:text-accent-foreground">
                <Monitor className="h-3.5 w-3.5" />
              </ToggleGroupItem>
              <ToggleGroupItem value="light" aria-label="Modo claro" className="flex-1 gap-1 px-2 py-1.5 text-xs data-[state=on]:bg-accent data-[state=on]:text-accent-foreground">
                <Sun className="h-3.5 w-3.5" />
              </ToggleGroupItem>
              <ToggleGroupItem value="dark" aria-label="Modo escuro" className="flex-1 gap-1 px-2 py-1.5 text-xs data-[state=on]:bg-accent data-[state=on]:text-accent-foreground">
